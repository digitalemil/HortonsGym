...
public class ArrayTupleTransformer extends BaseRichBolt {
	OutputCollector col;
	String[] definedKeys;
	...
	public void createAndEmit(Tuple tuple, JSONObject json) {
	...
	public void transformTuple(Tuple tuple) {
		...
		for(int i= 0; i< jsonArray.length(); i++) {
			createAndEmit(tuple, jsonArray.getJSONObject(i));
		}
		col.ack(tuple);		
	}
	...
	public ArrayTupleTransformer(String[] definedKeys) {
